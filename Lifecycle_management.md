...
4. Once image is available locally, please follow [user guide](https://earthdaily.github.io/analytics-datacube-processor/5.%20User%20guide.html) to run the procossor
...
![Get public IP](images/analyticsDataCube_API2.png "Get public IP")

Then you can use the API as described [here](analytics-datacube-processor/User%20guide.html#api-mode)
